...
export class HomeComponent implements OnInit {
  ...
  treatments:any = [
    ...
    {name:'Opioid addiction',text:"Alcohol addiction, also known as alcohol use disorder (AUD), is a chronic and often progressive disease characterized by a person's inability to control their consumption of alcohol despite negative consequences.",image:''},
